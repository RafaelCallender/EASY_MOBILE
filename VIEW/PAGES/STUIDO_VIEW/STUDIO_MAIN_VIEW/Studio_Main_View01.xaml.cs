...
namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.STUIDO_VIEW.STUDIO_MAIN_VIEW
{
    public partial class Studio_Main_View01 : ContentPage
    {
        ...
        private static string menu_string = $"studio\n" +
                                       $"go back\n";
        private static string[] menu_array = menu_string.Split("\n");

        public Studio_Main_View01()
        {
            InitializeComponent();
            load_Main_View01();
        }
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            await button01.Navigation.PushAsync(new Studio_Selection_View01());
        }
