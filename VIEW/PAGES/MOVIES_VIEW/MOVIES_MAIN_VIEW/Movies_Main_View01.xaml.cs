...
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.MOVIES_VIEW.MOVIES_SELECTION_VIEW;
...
namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.MOVIES_VIEW.MOVIES_MAIN_VIEW
{

    public partial class Movies_Main_View01 : ContentPage
    {
        ...
        private static string menu_string = $"movie 01\n" +
 $"back\n";
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            await button01.Navigation.PushAsync(new Movies_Selection_View01());
        }
