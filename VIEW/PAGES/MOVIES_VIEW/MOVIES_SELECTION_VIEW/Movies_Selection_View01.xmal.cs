...
namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.MOVIES_VIEW.MOVIES_SELECTION_VIEW
{
    public partial class Movies_Selection_View01 : ContentPage
    {
        ...
        private static string menu_string01 = "list all movies\n";
        ...
        public Movies_Selection_View01()
        {

            InitializeComponent();
            load_Movies_Selection_View01();
        }
            ...
            for (int i = 0; i < menu_array01.Length; i++)
            {
                ...
                switch (menu_array01[int.Parse(data01[4])])
                {
                    case "list all movies":
                        _commands.Add(procedure, list_all_movies);
                        break;
                }
            }
        }
        ...
        private void list_all_movies()
        {
            label01.Text = "not yet developed";
        }
        private void load_Movies_Selection_View01()
        {
            load_default_view();
        ...
        private async void button02_clicked(object? sender, EventArgs e)
        {
            ...
            await button02.Navigation.PushAsync(new Movies_Main_View01());
        }
    }
}