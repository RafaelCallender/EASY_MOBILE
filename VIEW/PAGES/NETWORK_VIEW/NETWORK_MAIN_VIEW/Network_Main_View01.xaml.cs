...
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.NETWORK_VIEW.NETWORK_SELECTION_VIEW;
...
namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.NETWORK_VIEW.NETWORK_MAIN_VIEW
{
    public partial class Network_Main_View01 : ContentPage
    {
        ...
        private static string menu_string = $"Network01\n" +
                                              $"go back\n";
        private static string[] menu_array = menu_string.Split("\n");
        public Network_Main_View01()
        {
            InitializeComponent();
            load_Main_View01();
        }
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            await button01.Navigation.PushAsync(new Network_Selection_View01());
        }
