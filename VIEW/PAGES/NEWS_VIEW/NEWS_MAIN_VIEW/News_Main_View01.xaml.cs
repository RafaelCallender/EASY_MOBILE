...
namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.NEWS_VIEW.NEWS_MAIN_VIEW
{

    public partial class News_Main_View01 : ContentPage
    {
        ...
        private static string menu_string = $"News API 01\n" +
                                              $"go back\n";
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            await button01.Navigation.PushAsync(new News_Selection_View01());
        }
