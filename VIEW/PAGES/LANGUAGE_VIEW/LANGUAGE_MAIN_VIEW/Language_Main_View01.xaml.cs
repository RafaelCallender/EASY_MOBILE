...
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.LANGUAGE_VIEW.LANGUAGE_SELECTION_VIEW;
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.FILES.FILE_MANAGER;

namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.LANGUAGE_VIEW.LANGUAGE_MAIN_VIEW
{

    public partial class Language_Main_View01 : ContentPage
    {
        ...
        private static string menu_string = $"Language sqlexperss\n" +
                 $"Language sqlite\n" +
                 $"Language Mysql\n" +
                 $"go back\n";
        private static string[] menu_array = menu_string.Split("\n");

        public Language_Main_View01()
        {
            InitializeComponent();
            load_Main_View01();
        }
      ...
      private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            await button01.Navigation.PushAsync(new Language_Selection_View01());
        }
      private async void button02_clicked(object? sender, EventArgs e)
        {
            await Button_A01.button_translateto(button01);
            await button01.Navigation.PushAsync(new Language_Selection_View02());
        }
        private async void button03_clicked(object? sender, EventArgs e)
        {
            await Button_A01.button_translateto(button01);
            await button01.Navigation.PushAsync(new Language_Selection_View03());
        }
