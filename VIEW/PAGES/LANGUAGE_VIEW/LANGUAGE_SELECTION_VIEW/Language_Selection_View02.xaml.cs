...
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_SERVICES.SQLITE_LANGUAGE_SERVICES;
...
{
    public partial class Language_Selection_View02 : ContentPage
    {
        ...
        private static Sqlite_Language_Services01 Sqlite_Language_S01 = new Sqlite_Language_Services01();
        private static bool stored_procedure_bool = Sqlite_Language_S01.view_language_database_storedprocedures(out data01[50]);
        ...
        public Language_Selection_View02()
        {
        ...
        private void find_code_using_code()
        {
            ...
            {
                if (Sqlite_Language_S01.find_code_using_code(entry01.Text, out data01[24]) == true)
                {
                    label01.IsVisible = true;
        ...
        private void find_code_using_language()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Language_S01.find_code_using_language(entry01.Text, out data01[24]) == true)
                {
                    label01.Text = data01[24];
                }
                else
        ...
        private void find_language_using_code()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Language_S01.find_language_using_code(entry01.Text, out data01[24]) == true)
                {
                    label01.Text = data01[24];
                }
                else
        ...
        private void find_language_using_Language()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sqlite_Language_S01.find_language_using_Language(entry01.Text, out data01[24]) == true)
                {
                    label01.Text = data01[24];
                }
                else
        ...
        {
            if (Sqlite_Language_S01.view_all_data_from_language_table(out data01[24]) == true)
            {
                label01.Text = data01[24];
            }
            else
        ...
        {
            if (Sqlite_Language_S01.view_language_database_storedprocedures(out data01[24]) == true)
            {
                label01.Text = data01[24];
            }
            else
