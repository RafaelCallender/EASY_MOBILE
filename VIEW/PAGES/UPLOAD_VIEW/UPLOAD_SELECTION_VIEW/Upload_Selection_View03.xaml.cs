...
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_SERVICES.SQLITE_UPLOAD_SERVICES;
...
{
    public partial class Upload_Selection_View03 : ContentPage
    {
        ...
        private static Sqlite_Upload_Services01 Sqlite_Upload_S01 = new Sqlite_Upload_Services01();
        private static bool stored_proccedure_bool = Sqlite_Upload_S01.view_database_storedprocedures(out data01[50]);
        private static string stored_proccedure_string = data01[50];
        private static string[] stored_proccedure_array = stored_proccedure_string.Split("\n");
        ...
        public Upload_Selection_View03()
        {
        ...
        private void delete_FilePath_using_FilePath()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.delete_FilePath_using_FilePath(entry01.Text, out data01[25]) == true)
                {
        ...
        private void delete_OriginalName_using_OriginalName()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.delete_OriginalName_using_OriginalName(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void delete_StoredName_using_StoredName()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.delete_StoredName_using_StoredName(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void delete_Username_using_Username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.delete_Username_using_Username(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_OriginalName_using_FilePath()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.find_OriginalName_using_FilePath(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_OriginalName_using_OriginalName()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.find_OriginalName_using_OriginalName(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_OriginalName_using_StoredName()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.find_OriginalName_using_StoredName(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_OriginalName_using_Username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.find_OriginalName_using_Username(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_StoredName_using_StoredName()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.find_StoredName_using_StoredName(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_StoredName_using_Username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.find_StoredName_using_Username(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_username_using_FilePath()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.find_username_using_FilePath(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_username_using_OriginalName()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.find_username_using_OriginalName(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_username_using_StoredName()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.find_username_using_StoredName(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_username_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Upload_S01.find_username_using_username(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void update_OriginalName_using_OriginalName()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_Upload_S01.update_OriginalName_using_OriginalName(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label01.Text = data01[25];
                }
                else
        ...
        private void update_StoredName_using_StoredName()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_Upload_S01.update_StoredName_using_StoredName(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label01.Text = data01[25];
                }
                else
        ...
        private void update_username_using_username()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_Upload_S01.update_username_using_username(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label01.Text = data01[25];
                }
                else
        ...
        private void load_User_Selection_View03_data()
        {
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            load_User_Selection_View03_data();
        }
