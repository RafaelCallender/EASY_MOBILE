...
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.SQL.SQL_SERVICES.SQL_JOURNAL_SERVICES;
...
{
    public partial class Journal_Selection_View01 : ContentPage
    {
        ...
        private static Sql_Journal_Services01 Sql_Journal_S01 = new Sql_Journal_Services01();
        private static bool stored_procedure_bool = Sql_Journal_S01.view_journal_database_storedprocedures(out data01[50]);
        ...
        private void find_message_using_message()
        {
            ...
            {
                if (Sql_Journal_S01.find_message_using_message(entry01.Text, out data01[24]) == true)
                {
        ...
        private void find_message_using_upload()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sql_Journal_S01.find_message_using_upload(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_message_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sql_Journal_S01.find_message_using_username(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_upload_using_message()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sql_Journal_S01.find_upload_using_message(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_upload_using_upload()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sql_Journal_S01.find_upload_using_upload(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_upload_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sql_Journal_S01.find_upload_using_username(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_username_using_message()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sql_Journal_S01.find_username_using_message(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_username_using_upload()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sql_Journal_S01.find_username_using_upload(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_username_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sql_Journal_S01.find_username_using_username(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
