...
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_SERVICES.SQLITE_JOURNAL_SERVICES;
...
{
    public partial class Journal_Selection_View03 : ContentPage
    {
        ...
        private static Sqlite_Journal_Services01 Sqlite_Journal_S01 = new Sqlite_Journal_Services01();
        private static bool stored_procedure_bool = Sqlite_Journal_S01.view_journal_database_storedprocedures(out data01[50]);
        ...
        public Journal_Selection_View03()
        {
            InitializeComponent();
        ...
        private void find_message_using_message()
        {
            ...
            {
                if (Sqlite_Journal_S01.find_message_using_message(entry01.Text, out data01[24]) == true)
                {
        ...
        private void find_message_using_upload()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sqlite_Journal_S01.find_message_using_upload(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_message_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sqlite_Journal_S01.find_message_using_username(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_upload_using_message()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sqlite_Journal_S01.find_upload_using_message(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_upload_using_upload()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sqlite_Journal_S01.find_upload_using_upload(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_upload_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sqlite_Journal_S01.find_upload_using_username(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_username_using_message()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sqlite_Journal_S01.find_username_using_message(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_username_using_upload()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sqlite_Journal_S01.find_username_using_upload(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
        ...
        private void find_username_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sqlite_Journal_S01.find_username_using_username(entry01.Text, out data01[24]) == true)
                {
                    label02.Text = data01[24];
                }
                else
