...
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.COLORS.COLORS_HELPER;
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.COLORS_VIEW.COLORS_MAIN_VIEW;
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.SECURITY_SERVICES;

namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.COLORS_VIEW.COLORS_SELECTION_VIEW
{
    public partial class Colors_Selection_View01 : ContentPage
    {
        ...
        private void load_Selection_data01()
        {
            for (int i = 0; i < menu_array01.Length; i++)
            {
                ...
                {
                    case "get colors":
                        _commands.Add(procedure, get_colors);
                        break;
                }
            }
        }
        ...
        private async void button02_clicked(object? sender, EventArgs e)
        {
            ...
            await button02.Navigation.PushAsync(new Colors_Main_View01());
        }
    }
}
