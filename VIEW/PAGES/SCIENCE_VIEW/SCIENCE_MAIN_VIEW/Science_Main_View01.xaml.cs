...
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.NEWS_VIEW.NEWS_SELECTION_VIEW;
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.SCIENCE_VIEW.SCIENCE_SELECTION_VIEW;
...
namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.SCIENCE_VIEW.SCIENCE_MAIN_VIEW
{
    public partial class Science_Main_View01 : ContentPage
    {
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            await button01.Navigation.PushAsync(new Science_Selection_View01());
        }
