...
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.DOCUMENT_VIEW.DOCUMENT_SELECTION_VIEW;

namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.DOCUMENT_VIEW.DOCUMENT_MAIN_VIEW
{

    public partial class Document_Main_View01 : ContentPage
    {
        ...
        private static string menu_string = $"upload document 01\n" +
                                              $"go back\n";
        private static string[] menu_array = menu_string.Split("\n");
        public Document_Main_View01()
        {
            InitializeComponent();
            load_Main_View01();
        }
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            await button01.Navigation.PushAsync(new Document_Selection_View01());
        }
