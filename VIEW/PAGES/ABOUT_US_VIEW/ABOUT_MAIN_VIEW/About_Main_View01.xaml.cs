...
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.ABOUT_US_VIEW.ABOUT_SELECTION_VIEW;
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.FILES.FILE_MANAGER;

namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.ABOUT_US_VIEW.ABOUT_MAIN_VIEW
{
    public partial class About_Main_View01 : ContentPage
    {
        ...
        private static string menu_string = $"about\n" +
        $"Back\n";

        private static string[] menu_array01 = menu_string.Split("\n");

        public About_Main_View01()
        {
            InitializeComponent();
           load_Main_View01();
        }
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            await button01.Navigation.PushAsync(new About_Selection_View01());
        }
