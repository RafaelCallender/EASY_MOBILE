...
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.CLIENT_VIEW.CLIENT_SELECTION_VIEW;
...
namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.CLIENT_VIEW.CLIENT_MAIN_VIEW
{
    public partial class Client_Main_View01 : ContentPage
    {
        ...
        private static string menu_string01 = $"sql client\n" +
        $"Mysql client\n" +
        $"back\n";
        private static string[] menu_array01 = menu_string01.Split("\n");
        public Client_Main_View01()
        {
            InitializeComponent();
            load_Main_View01();
        }
