...
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.STUIDO_VIEW.STUIDIO_SELECTION_VIEW;
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.TRANSLATE_VIEW.TRANSLATE_SELECTION_VIEW;
...
namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.TRANSLATE_VIEW.TRANSLATE_MAIN_VIEW
{

    public partial class Translate_Main_View01 : ContentPage
    {
        ...
        private static string menu_string = $"Translate\n" +
                                              $"go back\n";
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            await button01.Navigation.PushAsync(new Translate_Selection_View01());
        }
