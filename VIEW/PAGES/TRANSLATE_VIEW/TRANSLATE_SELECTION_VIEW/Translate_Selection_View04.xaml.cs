...
{
    public partial class Translate_Selection_View04 : ContentPage
    {
        ...
        private static string menu_string01 = $"not yet develop\n";
        ...
        private void load_Translate_Selection_View04_data()
        {
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            load_Translate_Selection_View04_data();
        }
