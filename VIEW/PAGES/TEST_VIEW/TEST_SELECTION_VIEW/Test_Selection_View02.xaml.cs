...
{
    public partial class Test_Selection_View02 : ContentPage
    {
        ...
        private static string menu_string01 = $"not yet develep\n";
        ...
        public Test_Selection_View02()
        {

            InitializeComponent();
            load_Test_Selection_View02();
        }
        ...
        private void load_Test_Selection_View02()
        {
        ...
        private void load_Test_Selection_View02_data()
        {
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            load_Test_Selection_View02_data();
        }
