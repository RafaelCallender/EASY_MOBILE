...
{
    public partial class Test_Selection_View07 : ContentPage
    {
 ...
 ;
        ...
        public Test_Selection_View07()
        {

            InitializeComponent();
            load_Test_Selection_View07();
        }
        ...
        private void load_Test_Selection_View07()
        {
            load_default_view01();
        ...
        private void load_Test_Selection_View07_data()
        {
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            load_Test_Selection_View07_data();
        }
