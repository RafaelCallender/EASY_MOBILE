...
{
    public partial class Test_Selection_View06 : ContentPage
    {
        ...
        public Test_Selection_View06()
        {

            InitializeComponent();
            load_Test_Selection_View06();
        }
        ...
        private void load_Test_Selection_View06()
        {
            load_default_view01();
        ...
        private void load_Test_Selection_View06_data()
        {
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            load_Test_Selection_View06_data();
        }
