...
{
    public partial class Test_Selection_View04 : ContentPage
    {
        ...
        public Test_Selection_View04()
        {

            InitializeComponent();
            load_Test_Selection_View04();
        }
        ...
        private void load_Test_Selection_View04()
        {
        ...
        private void load_Test_Selection_View04_data()
        {
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            await Button_A01.button_translateto(button01);
             load_Test_Selection_View04_data();
        }
