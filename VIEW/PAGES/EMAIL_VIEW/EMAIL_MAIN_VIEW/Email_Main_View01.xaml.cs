...
using EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.EMAIL_VIEW.EMAIL_SELECTION_VIEW;
...
namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.EMAIL_VIEW.EMAIL_MAIN_VIEW;

public partial class Email_Main_View01 : ContentPage
{
    ...
    private static string menu_string = $"email using sql\n" +
                $"email using sqlite\n" +
                $"email using Mysql\n" +
                $"send email\n" +
                $"go back\n";
