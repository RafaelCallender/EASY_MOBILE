...
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.MYSQL.MYSQL_SERVICES.MYSQL_EMAIL_SERVICES;
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_SERVICES.SQLITE_EMAIL_SERVICES;
...
{
    public partial class Email_Selection_View03 : ContentPage
    {
        ...
        private static bool stored_procedure_bool = Sqlite_Email_S01.view_email_database_storedprocedures(out data01[50]);
        ...
        private void insert_email()
        {
            ...
            if (Security_Serv01.empty_string(entry02.Text, out data01[25]) == true)
            {
                if (Security_Serv01.email_check(entry02.Text, out data01[26]) == true)
                {
            ...
            if (Security_Serv01.empty_string(entry03.Text, out data01[28]) == true)
            {
                if (Security_Serv01.phone_check(entry03.Text, out data01[29]) == true)
                {
                    counter++;
                    label03.IsVisible = false;
            ...
            if (Security_Serv01.empty_string(editor01.Text, out data01[30]) == true)
            {
                counter++;
                label04.IsVisible = false;
            ...
            if (counter == 4)
            {
                if (Email_S01.send_email(entry01.Text, entry02.Text, entry03.Text, editor01.Text, out data01[31]) == true)
                {
                    ...
                    if (Sqlite_Email_S01.insert_email(entry01.Text, entry02.Text, entry03.Text, editor01.Text, out data01[32]) == true)
                    {
        ...
        private void find_email_using_email()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                {
                    if (Sqlite_Email_S01.find_email_using_email(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = data01[25];
                    }
        ...
        private void find_email_using_name()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Email_S01.find_email_using_name(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = data01[25];
                }
        ...
        private void find_email_using_phonenumber()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                {
                    if (Sqlite_Email_S01.find_email_using_phonenumber(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = data01[25];
                    }
        ...
        private void find_full_name_using_email()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Security_Serv01.email_check(entry01.Text, out data01[24]) == true)
                {
                    if (Sqlite_Email_S01.find_full_name_using_email(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = data01[25];
                    }
        ...
        private void find_full_name_using_full_name()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Email_S01.find_full_name_using_full_name(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = data01[25];
                }
        ...
        private void find_full_name_using_phonenumber()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Security_Serv01.phone_check(entry01.Text, out data01[24]) == true)
                {
                    if (Sqlite_Email_S01.find_full_name_using_phonenumber(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = data01[25];
                    }
        ...
        private void find_phonenumber_using_email()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Security_Serv01.email_check(entry01.Text, out data01[24]) == true)
                {
                    if (Sqlite_Email_S01.find_phonenumber_using_email(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = data01[25];
                    }
        ...
        private void find_phonenumber_using_fullname()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_Email_S01.find_phonenumber_using_fullname(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = data01[25];
                }
        ...
        private void find_phonenumber_using_phonenumber()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Security_Serv01.phone_check(entry01.Text, out data01[24]) == true)
                {
                    if (Sqlite_Email_S01.find_phonenumber_using_phonenumber(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = data01[25];
                    }
