...
public partial class Email_Selection_View02 : ContentPage
{
    ...
    private static MySql_Email_Services01 MySql_Email_S01 = new MySql_Email_Services01();
    private static Email_Services01 Email_S01 = new Email_Services01();

    private static Security_Services01 Security_Serv01 = new Security_Services01();
    private static int counter = 0;
    private static bool stored_procedure_bool = MySql_Email_S01.view_email_database_storedprocedures(out data01[50]);
    ...
    private void insert_email()
    {
        ...
        if (counter == 4)
        {
            if (Email_S01.send_email(entry01.Text, entry02.Text, entry03.Text, editor01.Text, out data01[31]) == true)
            {
                ...
                if (MySql_Email_S01.insert_email(entry01.Text, entry02.Text, entry03.Text, editor01.Text, out data01[32]) == true)
                {
    ...
    private void find_email_using_email()
    {
        if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
        {
            ...
            {
                if (MySql_Email_S01.find_email_using_email(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = data01[25];
                }
    ...
    private void find_email_using_name()
    {
        if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
        {
            ...
            if (MySql_Email_S01.find_email_using_name(entry01.Text, out data01[25]) == true)
            {
                label01.IsVisible = true;
                label01.Text = data01[25];
            }
    ...
    private void find_email_using_phonenumber()
    {
        if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
        {
            ...
            {
                if (MySql_Email_S01.find_email_using_phonenumber(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = data01[25];
                }
    ...
    private void find_full_name_using_email()
    {
        if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
        {
            if (Security_Serv01.email_check(entry01.Text, out data01[24]) == true)
            {
                if (MySql_Email_S01.find_full_name_using_email(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = data01[25];
                }
    ...
    private void find_full_name_using_full_name()
    {
        if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
        {
            ...
            if (MySql_Email_S01.find_full_name_using_full_name(entry01.Text, out data01[25]) == true)
            {
                label01.IsVisible = true;
                label01.Text = data01[25];
            }
    ...
    private void find_full_name_using_phonenumber()
    {
        if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
        {
            if (Security_Serv01.phone_check(entry01.Text, out data01[24]) == true)
            {
                if (MySql_Email_S01.find_full_name_using_phonenumber(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = data01[25];
                }
    ...
    private void find_phonenumber_using_email()
    {
        if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
        {
            if (Security_Serv01.email_check(entry01.Text, out data01[24]) == true)
            {
                if (MySql_Email_S01.find_phonenumber_using_email(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = data01[25];
                }
    ...
    private void find_phonenumber_using_fullname()
    {
        if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
        {
            ...
            if (MySql_Email_S01.find_phonenumber_using_fullname(entry01.Text, out data01[25]) == true)
            {
                label01.IsVisible = true;
                label01.Text = data01[25];
            }
    ...
    private void find_phonenumber_using_phonenumber()
    {
        if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
        {
            if (Security_Serv01.phone_check(entry01.Text, out data01[24]) == true)
            {
                if (MySql_Email_S01.find_phonenumber_using_phonenumber(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = data01[25];
                }
