...
namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.USER_VIEW.USER_MAIN_VIEW
{
    public partial class User_Main_View01 : ContentPage
    {
        ...
        private static string menu_string = $"sqlexpress user\n" +
                                           $"mysql user\n" +
                                           $"sqlite\n"+
                                           $"back";
        ...
        private async void button01_clicked(object? sender, EventArgs e)
        {
            ...
            await button01.Navigation.PushAsync(new User_Selection_View01());
        }
        private async void button02_clicked(object? sender, EventArgs e)
        {
            await Button_A01.button_translateto(button01);
            await button01.Navigation.PushAsync(new User_Selection_View02());
        }
        private async void button03_clicked(object? sender, EventArgs e)
        {
            await Button_A01.button_translateto(button01);
            await button01.Navigation.PushAsync(new User_Selection_View03());
        }
