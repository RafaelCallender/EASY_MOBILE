...
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.SQL.SQL_SERVICES.SQL_USER_SERVICES;
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.SQL.SQL_SERVICES.SQL_USER_SERVICES;
...
using EASYPROJECT01.EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_SERVICES.SQLITE_USER_SERVICES;



namespace EASYPROJECT01.EASY_MOBILE.VIEW.PAGES.USER_VIEW.USER_SELECTION_VIEW
{
    public partial class User_Selection_View03 : ContentPage
    {
        ...
        private static Sqlite_User_Services01 Sqlite_User_S01 = new Sqlite_User_Services01();
        private static bool stored_proccedure_bool = Sqlite_User_S01.view_user_database_storedprocedures(out data01[50]);
        ...
        private void delete_user_using_phonenumber()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_User_S01.delete_user_using_phonenumber(entry01.Text, out data01[25]) == true)
                {
        ...
        private void delete_user_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_User_S01.delete_user_using_username(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_email_using_email()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Security_Serv01.email_check(entry01.Text, out data01[24]) == true)
                {
                    ...
                    if (Sqlite_User_S01.find_email_using_email(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = $"{data01[25]}\n";
                    }
        ...
        private void find_email_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_User_S01.find_email_using_username(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_password_using_email()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Security_Serv01.email_check(entry01.Text, out data01[24]) == true)
                {
                    if (Sqlite_User_S01.find_password_using_email(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = $"{data01[25]}\n";
                    }
        ...
        private void find_password_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_User_S01.find_password_using_username(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_phonenumber_using_email()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Security_Serv01.email_check(entry01.Text, out data01[24]) == true)
                {
                    ...
                    if (Sqlite_User_S01.find_phonenumber_using_email(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = $"{data01[25]}\n";
                    }
        ...
        private void find_phonenumber_using_phonenumber()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Security_Serv01.phone_check(entry01.Text, out data01[24]) == true)
                {
                    ...
                    if (Sqlite_User_S01.find_user_location_using_username(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = $"{data01[25]}\n";
                    }
        ...
        private void find_phonenumber_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_User_S01.find_phonenumber_using_username(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_username_password()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_User_S01.find_username_password(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void find_username_using_email()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Security_Serv01.empty_string(entry01.Text, out data01[24]) == true)
                {
                    ...
                    if (Sqlite_User_S01.find_username_using_email(entry01.Text, out data01[25]) == true)
                    {
                        label01.IsVisible = true;
                        label01.Text = $"{data01[25]}\n";
                    }
        ...
        private void find_username_using_username()
        {
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                ...
                if (Sqlite_User_S01.find_username_using_username(entry01.Text, out data01[25]) == true)
                {
                    label01.IsVisible = true;
                    label01.Text = $"{data01[25]}\n";
                }
        ...
        private void insert_user()
        {
            ...
            if (Security_Serv01.empty_string(entry01.Text, out data01[23]) == true)
            {
                if (Sqlite_User_S01.find_username_using_username(entry01.Text, out data01[25]) == false)
                {
                    counter01++;
            ...
            if (counter01 == 10)
            {
                if (Sqlite_User_S01.insert_user(entry01.Text, entry02.Text, entry03.Text, entry04.Text, entry05.Text, entry06.Text, entry07.Text, out data01[1]) == true)
                {
        ...
        private void update_email_using_email()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_email_using_email(entry01.Text, entry02.Text, out data01[25]) == true)
                {
        ...
        private void update_email_using_username()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_email_using_username(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label01.Text = data01[25];
                }
                else
        ...
        private void update_password_using_email()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_password_using_email(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label02.Text = data01[25];
                }
                else
        ...
        private void update_password_using_phonenumber()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_password_using_phonenumber(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label01.Text = data01[25];
                }
                else
        ...
        private void update_password_using_username()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_password_using_username(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label02.Text = data01[25];
                }
                else
        ...
        private void update_phonenumber_using_email()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_phonenumber_using_email(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label02.Text = data01[25];
                }
                else
        ...
        private void update_phonenumber_using_username()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_phonenumber_using_username(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label02.Text = data01[25];
                }
                else
        ...
        private void update_user_location_using_email()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_user_location_using_email(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label02.Text = data01[25];
                }
                else
        ...
        private void update_user_location_using_name()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_user_location_using_name(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label02.Text = data01[25];
                }
                else
        ...
        private void update_user_location_using_phonenumber()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_user_location_using_phonenumber(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label02.Text = data01[25];
                }
                else
        ...
        private void update_user_location_using_username()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_user_location_using_username(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label02.Text = data01[25];
                }
                else
        ...
        private void update_username_using_email()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_username_using_email(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label02.Text = data01[25];
                }
                else
        ...
        private void update_username_using_phonenumber()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_username_using_phonenumber(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label01.Text = data01[25];
                }
                else
        ...
        private void update_username_using_username()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.update_username_using_username(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label01.Text = data01[25];
                }
                else
        ...
        private void user_login()
        {
            ...
            if (counter01 == 2)
            {
                if (Sqlite_User_S01.user_login(entry01.Text, entry02.Text, out data01[25]) == true)
                {
                    label01.Text = data01[25];
                }
                else
        ...
        {
            //label01.Text = Sqlite_User_S01.view_all_emails();
            label01.Text = "needs work";
        }
        private void view_all_passwords()
        {
            if (Sqlite_User_S01.view_all_passwords(out data01[23]) == true)
            {
                label01.Text = data01[23];
            }
            else
        ...
        {
            if (Sqlite_User_S01.view_all_phonenumber(out data01[23]) == true)
            {
                label01.Text = data01[23];
            }
            else
        ...
        {
            if (Sqlite_User_S01.view_all_username(out data01[23]) == true)
            {
                label01.Text = data01[23];
            }
            else
